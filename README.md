...
> "A repetição com esforço inteligente leva à maestria." 🧠

---

## 🛠️ Tecnologias & Ferramentas
* **Linguagem Principal:** C++ / Python / JavaScript *(coloque as suas aqui)*
* **Ambiente:** VS Code / Neovim
* **Padronização:** Cada desafio possui seu próprio enunciado detalhado e análise de complexidade ($O(n)$, $O(1)$, etc.).

---

## 📈 Meu Progresso

Abaixo está o índice de desafios resolvidos, organizados por ordem de conclusão:

| # | Desafio | Dificuldade | Categoria | Solução |
| :-: | :--- | :---: | :---: | :-: |
| 01 | [🎯 Two Sum](./01-two-sum) | 🟢 Fácil | Array / Hash Table | [Código](./01-two-sum/solucao.cpp) |
| 02 | [🔄 Palindrome Number](./02-palindrome-number) | 🟢 Fácil | Matemática | [Código](./02-palindrome-number/solucao.py) |
| 03 | [🏛️ Roman to Integer](./03-roman-to-integer) | 🟢 Fácil | String / Math | [Código](./03-roman-to-integer/solucao.js) |
| 04 | *Em breve...* | 🟡 Média | — | — |

*Legenda de Dificuldade: 🟢 Fácil | 🟡 Média | 🔴 Difícil*
...
└── 📂 01-two-sum/               # Pasta de um desafio específico
    ...
    └── 💻 solucao.cpp           # Código-fonte da resolução